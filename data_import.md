...
Let’s read in an Excel file. Better to load entire package for the
readxl case, as sometimes there are helper functions working in the
background.
...
What about `read.csv` … ? Never use. Base R version is more difficult to
look at.
